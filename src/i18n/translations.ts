  ...
  en: {
    ...
    portfolioPage: {
      ...
      independentProjects: [
        ...
        {
          id: 'fried-chicken',
          title: 'Fried Chicken. Fast Food Brand Site',
          desc: 'Experimental food brand site with bold typography and fluid GSAP transitions.',
          tags: ['REACT', 'GSAP', 'MICRO-ANIMATIONS'],
          visualAlt: 'Fast food brand website mockup',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          id: 'hestus-ai',
          title: 'Hestus AI. SaaS Landing Concept',
          desc: 'Dark glassmorphism landing page concept for an AI automation platform.',
          tags: ['TAILWIND CSS', 'GLASSMORPHISM', 'REACT'],
          visualAlt: 'Dark glassmorphism landing page mockup',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          id: 'devsclub-store',
          ...
          visualAlt: 'Streetwear e-commerce store mockup',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          id: 'nexus-studio',
          ...
          tags: ['REACT FLOW', 'AI AGENTS', 'TYPESCRIPT'],
          visualAlt: 'AI workflow builder canvas mockup',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          ...
          tags: ['DATA VISUALIZATION', 'RECHARTS', 'REAL-TIME'],
          visualAlt: 'Cloud analytics dashboard mockup',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          ...
          tags: ['DESIGN SYSTEM', 'RADIX UI', 'ACCESSIBILITY'],
          visualAlt: 'UI component library showcase mockup',
          url: 'https://gustavogalvao.vercel.app',
        },
      ],
      footerCta: {
  ...
  pt: {
    ...
    portfolioPage: {
      ...
      independentProjects: [
        ...
        {
          id: 'fried-chicken',
          title: 'Fried Chicken. Site de Marca Fast Food',
          desc: 'Conceito visual arrojado com tipografia marcante e animações fluidas em GSAP.',
          tags: ['REACT', 'GSAP', 'MICRO-ANIMAÇÕES'],
          visualAlt: 'Mockup de site de fast food',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          id: 'hestus-ai',
          title: 'Hestus AI. Conceito SaaS',
          desc: 'Landing page em tema escuro com glassmorphism para plataforma de automação.',
          tags: ['TAILWIND CSS', 'GLASSMORPHISM', 'REACT'],
          visualAlt: 'Mockup de landing page em glassmorphism',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          id: 'devsclub-store',
          title: 'DevsClub Store. E-Commerce Streetwear & Merch',
          desc: 'Loja virtual de alta performance com carrinho reativo, cálculo dinâmico e checkout integrado.',
          tags: ['NEXT.JS', 'E-COMMERCE', 'STRIPE'],
          visualAlt: 'Mockup de loja virtual de streetwear',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          id: 'nexus-studio',
          title: 'Nexus Studio. Construtor de Automações com IA',
          desc: 'Espaço de trabalho baseado em nós para conectar webhooks, LLMs e APIs de mensagens.',
          tags: ['REACT FLOW', 'AGENTES IA', 'TYPESCRIPT'],
          visualAlt: 'Mockup de construtor de fluxo com IA',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          id: 'cloudpulse-metrics',
          title: 'CloudPulse. Dashboard Cloud em Tempo Real',
          desc: 'Interface analítica para monitoramento de tráfego, integridade de servidores e métricas de conversão.',
          tags: ['VISUALIZAÇÃO DE DADOS', 'RECHARTS', 'TEMPO REAL'],
          visualAlt: 'Mockup de dashboard de métricas em nuvem',
          url: 'https://gustavogalvao.vercel.app',
        },
        {
          id: 'aura-design-system',
          title: 'Aura UI. Design System Padrão Apple',
          desc: 'Biblioteca de componentes modulares construída com Tailwind CSS, Framer Motion e glassmorfismo líquido.',
          tags: ['DESIGN SYSTEM', 'RADIX UI', 'ACESSIBILIDADE'],
          visualAlt: 'Mockup de biblioteca de componentes UI',
          url: 'https://gustavogalvao.vercel.app',
        },
      ],
      footerCta: {
