    ...
    portfolioPage: {
      ...
      clientProjects: [
        ...
        },
        {
          ...
          title: 'Speak Flow',
          year: '2026',
          client: 'English Teacher',
          challenge: 'Build a modern and professional platform for English teaching.',
          solution: 'Full site build delivering a premium experience for an independent English teacher.',
          tags: ['FULL SITE', 'REACT', 'EDUCATION'],
          visualAlt: 'Speak Flow website interface',
        },
      ...
      independentProjects: [
        ...
        },
        {
          ...
          desc: 'High-performance landing page for patient acquisition and integrated conversion funnel.',
          tags: ['MARKETING TECH', 'HTML5/CSS3', 'SALES FUNNEL'],
          visualAlt: 'SorrisoPerfeito dental landing page mockup',
          url: 'https://sorrisoperfeito-swart.vercel.app',
        },
      ],
      footerCta: {
    ...
    portfolioPage: {
      ...
      clientProjects: [
        ...
        },
        {
          ...
          title: 'Speak Flow',
          year: '2026',
          client: 'Professora de Inglês',
          challenge: 'Construir uma plataforma moderna e profissional para o ensino de inglês.',
          solution: 'Site completo entregando uma experiência premium para atrair novos alunos.',
          tags: ['FULL SITE', 'REACT', 'EDUCAÇÃO'],
          visualAlt: 'Interface do site Speak Flow',
        },
        {
          id: 'ac-joias',
          title: 'Ariane Carla Joias',
      ...
      independentProjects: [
        ...
        {
          id: 'sorrisoperfeito',
          title: 'SorrisoPerfeito. Landing Page Odontológica & Captação',
          desc: 'Landing page de alta performance para captação de pacientes e funil integrado de conversão.',
          tags: ['MARKETING TECH', 'HTML5/CSS3', 'FUNIL DE VENDAS'],
          visualAlt: 'Mockup de landing page odontológica SorrisoPerfeito',
          url: 'https://sorrisoperfeito-swart.vercel.app',
        },
      ],
      footerCta: {
