...
export const projectsData: Record<'pt' | 'en', Record<string, ProjectDetail>> = {
  pt: {
    ...
    'speak-flow': {
      ...
      desc: 'Uma landing page construída do zero para Anna Luíza, professora de inglês particular em Camaçari, Bahia — aulas online e presenciais. Codificada à mão com HTML, CSS e JS.',
      fullDescription: 'Uma landing page construída do zero para Anna Luíza, professora de inglês particular em Camaçari, Bahia — aulas online para todo o país, presenciais/híbridas em Camaçari. Página única (single-page), codificada à mão em HTML, CSS e JavaScript, focada em SEO e GEO.',
      challenge: 'Anna tinha uma base crescente de alunos por indicação, mas nenhum site — cada contato começava do zero no WhatsApp, e ela não tinha visibilidade no Google.',
      solution: 'Um site single-page totalmente responsivo estruturado como um funil de conversão: hero, quebra de objeções, modalidades, como funciona, bio da professora, depoimentos, preços e FAQ — tudo levando para uma chamada de ação (CTA) via WhatsApp. Construído com HTML semântico e copy otimizada para ranquear no Google e ser citada por motores de inteligência artificial (GEO).',
      features: [
  ...
  en: {
    ...
    'speak-flow': {
      ...
      image: '/img/speakflow.webp',
      videoPoster: '/img/speakflow.webp',
      desc: 'A landing page built from scratch for Anna Luíza, a private English teacher in Camaçari, Bahia — online classes nationwide, in-person/hybrid in Camaçari.',
      fullDescription: 'A landing page built from scratch for Anna Luíza, a private English teacher in Camaçari, Bahia — online classes nationwide, in-person/hybrid in Camaçari. Single-page, hand-coded in HTML, CSS, and JavaScript, built around SEO and GEO.',
      challenge: 'Anna had a growing student base by word of mouth but no website — every inquiry started from zero on WhatsApp, and she had zero visibility on Google.',
      solution: 'A fully responsive, single-page site structured as a conversion funnel: hero, objection-handling, class modalities, how-it-works, teacher bio, testimonials, pricing, and FAQ — all leading to one WhatsApp CTA. Built with semantic HTML and content phrased to rank on Google and get cited by AI answer engines (GEO).',
      features: [
