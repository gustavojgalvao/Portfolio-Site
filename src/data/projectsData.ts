...
export const projectsData: Record<'pt' | 'en', Record<string, ProjectDetail>> = {
  pt: {
    brl2go: {
      ...
      type: 'independent',
      image: '/img/BRL2GO.webp',
      videoPoster: '/img/BRL2GO.webp',
    ...
    'fried-chicken': {
      ...
      type: 'independent',
      image: '/img/Fried-chicken.webp',
      videoPoster: '/img/Fried-chicken.webp',
    ...
    'hestus-ai': {
      ...
      type: 'independent',
      image: '/img/hestus.webp',
      videoPoster: '/img/hestus.webp',
    ...
    'devsclub-store': {
      ...
      type: 'independent',
      image: '/img/devsclub-store.webp',
      videoPoster: '/img/devsclub-store.webp',
    ...
    'lu-phellipo': {
      ...
      type: 'independent',
      image: '/img/LuPhellipo.webp',
      videoPoster: '/img/LuPhellipo.webp',
    ...
    'cebe-portal': {
      ...
      type: 'independent',
      image: '/img/CEBEPortal.webp',
      videoPoster: '/img/CEBEPortal.webp',
    ...
    promptbase: {
      ...
      type: 'independent',
      image: '/img/PromptBase.webp',
      videoPoster: '/img/PromptBase.webp',
    ...
    sorrisoperfeito: {
      ...
      type: 'independent',
      image: '/img/sorrisoPerfeito.webp',
      videoPoster: '/img/sorrisoPerfeito.webp',
    ...
    g2odonto: {
      ...
      type: 'client',
      image: '/img/lentesdecontatodental.webp',
      videoPoster: '/img/lentesdecontatodental.webp',
    ...
    'ac-joias': {
      ...
      type: 'client',
      image: '/img/arianacarla.webp',
      videoPoster: '/img/arianacarla.webp',
