...
export const projectsData: Record<'pt' | 'en', Record<string, ProjectDetail>> = {
  pt: {
    ...
    'speak-flow': {
      ...
      category: 'Full Site Build / Plataforma de Serviços',
      type: 'client',
      image: '/img/SpeakFlow.png',
      videoPoster: '/img/SpeakFlow.png',
      desc: 'Um site completo e profissional para uma professora de inglês independente. Projetado para apresentar a metodologia, atrair novos alunos e transmitir credibilidade através de um design premium e responsivo.',
      fullDescription: 'O Speak Flow foi desenvolvido do zero para representar o trabalho de ensino de inglês de Anna Luíza. A plataforma foca em uma experiência de usuário (UX) clara e sofisticada, permitindo que potenciais alunos conheçam os serviços, a metodologia e entrem em contato diretamente.',
      challenge: 'A cliente precisava de uma presença digital que superasse a concorrência e transmitisse o nível de qualidade das suas aulas, facilitando o agendamento de alunos de forma centralizada.',
      solution: 'Foi desenvolvido um "Full Site Build" com React, focado em performance, design minimalista premium e SEO otimizado. O layout responsivo garante que a experiência seja impecável tanto no desktop quanto no mobile.',
      features: [
        'Design Responsivo: Layout adaptável a todos os dispositivos.',
        'UX Premium: Animações sutis e tipografia cuidadosa para transmitir profissionalismo.',
        'Integração de Contato: Fluxo facilitado para captura de novos alunos.'
      ],
      techStack: ['React', 'TypeScript', 'TailwindCSS', 'Framer Motion'],
      metrics: [],
      githubUrl: '',
      liveUrl: 'https://speakflow.vercel.app',
      isOnline: true,
    },
    g2odonto: {
      id: 'g2odonto',
    ...
    'ac-joias': {
      ...
      githubUrl: 'https://acjoias.art.br',
  ...
  en: {
    ...
    'speak-flow': {
      ...
      category: 'Full Site Build / Service Platform',
      type: 'client',
      image: '/img/SpeakFlow.png',
      videoPoster: '/img/SpeakFlow.png',
      desc: 'A complete and professional website for an independent English teacher. Designed to showcase her methodology, attract new students, and convey credibility through a premium, responsive design.',
      fullDescription: 'Speak Flow was built from scratch to represent Anna Luíza\'s English teaching services. The platform focuses on a clear and sophisticated user experience (UX), allowing potential students to learn about the services, the methodology, and get in touch directly.',
      challenge: 'The client needed a digital presence that would stand out from the competition and convey the high quality of her classes, making student scheduling and intake effortless.',
      solution: 'A "Full Site Build" developed with React, focusing on performance, premium minimalist design, and SEO optimization. The responsive layout ensures a flawless experience on both desktop and mobile devices.',
      features: [
        'Responsive Design: Layout that adapts perfectly to all devices.',
        'Premium UX: Subtle animations and careful typography to convey professionalism.',
        'Contact Integration: Streamlined flow for capturing new student leads.'
      ],
      techStack: ['React', 'TypeScript', 'TailwindCSS', 'Framer Motion'],
      metrics: [],
      githubUrl: '',
