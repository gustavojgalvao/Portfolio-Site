...
export const projectsData: Record<'pt' | 'en', Record<string, ProjectDetail>> = {
  pt: {
    brl2go: {
      ...
      category: 'Fintech & Web Tools',
      type: 'independent',
      image: '/img/Conversor de Moedas em tempo real.png',
      videoPoster: '/img/Conversor de Moedas em tempo real.png',
      desc: 'Aplicação reativa para conversão instantânea de câmbio entre múltiplas moedas globais com consumo de API ao vivo.',
      fullDescription:
      ...
      challenge:
        'Conversores cambiais tradicionais são pesados, cheios de anúncios invasivos e lentos para atualizar pares em tempo real no mobile.',
      solution:
        'Desenvolvimento de uma Single Page Application em React e TypeScript com cache inteligente de cotações, interface mobile-first glassmorphism e cálculo sem reloads.',
      features: [
        'Cotações comerciais atualizadas via REST API em tempo real',
        'Inversão bidirecional de moedas com 1 clique (Swap)',
        'Cálculo e formatação instantânea a cada dígito digitado',
        'Design 100% responsivo com glassmorfismo e tema escuro Apple',
        'Arquitetura modular com React 19 e TypeScript com tipagem estrita',
      ],
      techStack: ['React 19', 'TypeScript', 'Tailwind CSS', 'REST API', 'Framer Motion', 'Lucide Icons'],
      metrics: [
        { label: 'Performance Lighthouse', value: '100/100' },
        { label: 'Tempo de Resposta', value: '< 120ms' },
        { label: 'Moedas Suportadas', value: '6+ Pares' },
  ...
  en: {
    brl2go: {
      ...
      image: '/img/Conversor de Moedas em tempo real.png',
      videoPoster: '/img/Conversor de Moedas em tempo real.png',
      desc: 'Reactive web application for instantaneous exchange rate calculations across major global currencies with live API feeds.',
      fullDescription:
      ...
      challenge:
        'Traditional currency calculators are bloated with ad banners and lag on mobile browsers.',
      solution:
        'Engineered a sleek React and TypeScript SPA featuring smart rate caching, mobile-first Apple glassmorphism, and zero reload calculations.',
      features: [
        'Live exchange rates powered by real-time financial REST APIs',
        'One-click bidirectional currency swap',
        'Instantaneous calculation as the user types',
        'Responsive Apple-style dark glassmorphism layout',
        'Strictly typed modular architecture with React 19',
      ],
      techStack: ['React 19', 'TypeScript', 'Tailwind CSS', 'REST API', 'Framer Motion', 'Lucide Icons'],
      metrics: [
        { label: 'Lighthouse Score', value: '100/100' },
        { label: 'Response Latency', value: '< 120ms' },
        { label: 'Supported Currencies', value: '6+ Pairs' },
